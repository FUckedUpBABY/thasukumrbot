...
import threading
stopuser = {}
token = '7297041851:AAETPphjuLWHxzuTB7d7CxTF5LrqX3HXkOs'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/stripe_xD")
			contact_button = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/NoMoreBins")
...
YOUR CURRENT PLAN IS :  {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥 ✨", url="https://t.me/stripe_xD")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ✨", url="https://t.me/NoMoreBins")
		keyboard.add(contact_button, ahmed)
...
𝘽𝙤𝙩 𝘽𝙮 @stripe_xD''', reply_markup=mes)
...
◆ 𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
					if 'success' in last:
						tok = '7297041851:AAETPphjuLWHxzuTB7d7CxTF5LrqX3HXkOs'
						acc =  '-1002215376775'
						mg = f"""<b> 
❆═══» MAGICAL HITS  «═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ DEV  ✨", url="https://t.me/stripe_xD")
		ahmed = types.InlineKeyboardButton(text="✨ CHANNEL  ✨", url="https://t.me/NoMoreBins")
		keyboard.add(contact_button, ahmed)
